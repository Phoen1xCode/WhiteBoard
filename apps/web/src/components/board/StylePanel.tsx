...
export function StylePanel() {
  ...
  return (
    <div className="fixed top-20 left-4 w-52 overflow-hidden rounded-base border-2 border-border bg-background shadow-shadow">
      {/* Header */}
      <div className="flex items-center gap-2 border-b-2 border-border bg-secondary-background px-3 py-2.5">
        <Palette size={14} className="text-foreground" />
        <span className="text-xs font-heading text-foreground">Style</span>
      </div>
